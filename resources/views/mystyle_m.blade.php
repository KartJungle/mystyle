                    ...
                    <div class="col-sm-6">
                        <form action="r" method="post" accept-charset="utf-8" class="form" role="form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-md-4">
                                    <input type="text" name="lastname" value="" class="form-control input-lg" placeholder="Biceps" />
                                </div>
                                <div class="col-xs-4 col-md-4">
                                    <input type="text" name="lastname" value="" class="form-control input-lg" placeholder="Chest" />
                                </div>
                            </div>
